 ...
 *
 * 🎯 MISSION
 * Créez une fonction estPalindrome(mot) (vous pouvez ignorer les majuscules et espaces pour l'instant)
 *  qui retourne true si le mot se lit dans les deux sens (ex: "radar").
...
{
    let check = mot.split('').reverse().join('') 
    if(check === mot)
        return true
    else
        return false
