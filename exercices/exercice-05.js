 ...
 *
 * 🎯 MISSION
 * Écrivez une fonction perimetreRectangle(longueur, largeur = 5). 
 * Si la largeur n'est pas fournie lors de l'appel, elle vaudra 5 par défaut.
 *  Testez-la avec perimetreRectangle(10).
 *
